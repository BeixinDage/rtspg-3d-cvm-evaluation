...
p.addOptional('Ncircles',3);
p.addOptional('autoOrigin','on');
p.addOptional('Nspokes',13);
...
if colBar==1,
    c =colorbar('location','SouthOutside','fontsize',12);
    c.Label.String = '\Deltat(s)';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    function createSpokes(thetaMin,thetaMax,Ncircles,circlesPos,Nspokes)
        ...
        for kk = 1:Nspokes
            ...
            plot(X,Y,'color',[0.5,0.5,0.5],'linewidth',1.0,...
