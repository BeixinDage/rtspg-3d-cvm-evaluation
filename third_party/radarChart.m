...
% gzh  : slandarer随笔
    properties
        ...
        XData;RTick=[];RLim=[-5 5];SepList=[1,1.2,1.5,2,2.5,3,4,5,6,8]
        Type='Line';
        PropNum;ClassNum
        ClassName={};
        PropName={};
    ...
    methods
        function obj=radarChart(varargin)
            ...
            obj.RLim=[min(min(obj.XData)),max(max(obj.XData))];
...
% =========================================================================
        ...
        function obj=legend(obj)
            if isequal(obj.Type,'Line')
                obj.LgdHdl=legend(obj.ax,[obj.PatchHdlL],obj.ClassName,'FontSize',12,'Orientation','horizontal','Location',[0.5 0.01 0.03 0.03],'Tag','SRClagend');
            else
                obj.LgdHdl=legend(obj.ax,[obj.PatchHdlP],obj.ClassName,'FontSize',12,'Orientation','horizontal','Location',[0.5 0.01 0.03 0.03],'Tag','SRClagend');
            end
        end
