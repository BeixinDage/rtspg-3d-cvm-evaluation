...
%     % colormap(jetwr);
%     clrmp_ncl1=(nclcmap(122,1800));
%     clrmp_ncl2=(nclcmap(122,600));
%     clrmp_ncl3=(nclcmap(122,1800));
%     clrmp_ncl=[clrmp_ncl1(1:600,:);clrmp_ncl2(201:400,:);clrmp_ncl3(1201:end,:)];
%     if exist('clrmp')
%         colormap(clrmp);
% 
%     else
%         colormap(clrmp_ncl(1:end,:));
% 
%     end
end
    ...
    for i=1:d:ntraces
        ...
        if (strmatch('VA',style)==1)
            ...
            if ax_order==1;
                ...
                plot(xt+x(i),t,'-','linewidth',0.1,'color',lineColor);
            else
                plot(t,xt+x(i),'-','linewidth',0.1,'color',lineColor);
            end
            %OCTAVE PLOT
            %plot(xt+x(i),t,'k-')
        end
